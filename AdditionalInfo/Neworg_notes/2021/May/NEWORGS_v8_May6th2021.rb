...
# Completed (as of May 6th 2021)

puts "| Completed {
* seanpm2001-gaming - For all gaming projects (game programs and gaming images) the original must never receive image forks
* seanpm2001-apple
* seanpm2001-Android
* seanpm2001-privacy
* SNU-Translate
...
* ultraswitch-dev
* svg-video-consortium
* skeuowie-de
* SNU TV { TV, Charcast, WatchParty
* SNU Beliefs
* SNU Sports
* SNU Vexillology
* SNU eGret
...
* seanpm2001-gnome
* FourThousandNinetySixDev
* Seanpm2001-themes { BlueCalm Theme }
* Seanpm2001-psychology { BlueCalm Theme, Nostalgia Project }
} | "
...
# LATE, LATE, LATE
# * seanpm2001-politics - For political projects, to remain neutral, make the icon a V or a "vote" symbol

# V8 - May 6th 2021

# Now a proper (but not very readable) Ruby file
